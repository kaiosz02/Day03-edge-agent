...
def run_react_agent(user_query: str, provider):
    """Vận hành mô hình ReAct Agent theo chu trình (Suy luận -> Hành động -> Quan sát)."""
...
if __name__ == "__main__":
    ...
    choice = input("Nhập ID kịch bản cần thực thi (1-16) hoặc nhập 'all' để chạy toàn bộ: ").strip().lower()
    
    if choice == 'all':
        print("\nBẮT ĐẦU THỰC THI HÀNG LOẠT KỊCH BẢN KIỂM THỬ...\n")
        results = []
        for test in tests:
            print("\n" + "="*50)
