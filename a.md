...
[Onboarding] → [Nhập hồ sơ] → [Nhận thực đơn] → [Log bữa ăn] → [Nhận phản hồi] → [Tái khám]
      |               |               |                  |                |               |
  Nhập bệnh lý,   AI phân tích   Thực đơn 7 ngày    Chụp ảnh/      Cảnh báo nếu    Bác sĩ xem
  thuốc đang dùng, ràng buộc,    cá nhân hoá,       nhập thủ công, vượt ngưỡng,   data nhật ký
  mục tiêu sức khoẻ giới hạn     có nguồn VN        AI nhận diện   gợi ý điều      trước khi tư vấn
                    ăn kiêng      thực phẩm          & tính kcal    chỉnh
